 ...
 <form method="post">
			 ...
			 <thead>
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        $date=date("d/m/y");
			//			$res1=mysql_query("select * from user_tbl where type='user' and status='true' and join_date='$date'",$con);
	...
	//		while($row=mysql_fetch_array($res1,MYSQL_ASSOC))
		...
		//	echo $m1;			
						...
						$res=mysql_query("select * from user_tbl where type='user' and status='true' and MONTH(join_date)='$m1'",$con);  
