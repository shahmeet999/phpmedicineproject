...
<br/><br/>
				...
				<?php 
				 $con=mysql_connect("localhost","root","");
                        ...
                        $res=mysql_query("select ca.*,c.*,p.* from category_tbl as ca,company_tbl as c,product_tbl as p where p.category_id=ca.category_id and p.company_id=c.company_id");
