            ...
            <form method="post" action="edit_company.php?id=<?php echo $id;?>" role="form">
			  ...
			  <div class="form-group" hidden>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txt_comname" value="<?php echo $name;?>" required>
                </div>
				<div class="form-group">
                  <label>Edit Company Address</label>
                  <input type="text" class="form-control" name="txt_comadd" value="<?php echo $add;?>" required>
                </div>
				<div class="form-group">
