            ...
            <form method="post" role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="txt_comname" placeholder="Enter Company Name" required>
                </div>
				<div class="form-group">
				...
				<div class="form-group">
                  ...
                  <input type="number" class="form-control" name="txt_contact" placeholder="Enter Company Number" required>
                </div>
